...
if($MarcasInstanciada == '') {
	...
	class Marcas {
		...
		public static function getInstance($conexao){   
			if (!isset(self::$Marcas)):    
				self::$Marcas = new Marcas($conexao);   
			endif;
			return self::$Marcas;    
		}
		...
		function rsDados($id='', $orderBy='', $limite='') {
			...
			try{   
				$sql = "SELECT * FROM tbl_marcas where 1=1 $sql $sqlOrdem $sqlLimite";
