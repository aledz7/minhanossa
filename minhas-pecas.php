...
<html lang="pt_BR">
	<head>
		<title>Minha Nossa! - Nossos Editoriais - Multimarcas de Empréstimos de Roupas em Brasília DF</title>
		<meta charset="UTF-8">
		<meta name="author" content="DFinformatica">
		<meta name="keywords" content="roupas">
		<meta name="description" content="Nossos Editoriais - Transformando o guarda-roupa feminino em um universo de possibilidades">
                ...
                <div class="row row-centered" style="background-color: #fff; padding-top: 40px;" >
					<div class="col-xs-12 col-sm-10 col-md-6 col-lg-10 col-centered">
							...
							<div class="col-sm-12 mg-lft-15p">
                                ...
                                ?>
									<a href="minhas-pecas.php?categoria=<?php echo $item->id; ?>">
							...
							<?php if($_GET['categoria'] <> '' || $_GET['sub_categoria'] <> ''){?>
								<div class="col-sm-12 mg-lft-15p">
									...
									?>
										<a href="minhas-pecas.php?categoria=<?php echo $_GET['categoria']?>&sub_categoria=<?php echo $item->id; ?>">
											<div class="tags-categoria">
                  ...
                  <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 col-centered">
                    <div class="col-sm-12 lib-item" data-category="view">
                      ...
                      <div class="text-center">
					  	 <a class="pagination__next" href="minhas-pecas.php?pagina=1&<?php echo $_SERVER['QUERY_STRING']?>"></a>
...
-->
	...
	<script>
		function bt_add() {
			...
			var url = 'mais-pecas.php?&<?php echo $_SERVER['QUERY_STRING']?>&pagina='+proxima_pagina;
			//alert(url);
