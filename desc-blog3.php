...
-->
                        <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                            <div class="lib-row lib-header">
                                ...
                                <h1 class="text-center" style="color: white; text-shadow: #000 -3px 1px 4px;"><span style="color: #f1c93b; text-shadow: #000 -0px 1px 4px;"><?php echo utf8_decode($desc_blog->titulo);?></span><span style="color: #c25868;"><?php echo utf8_decode($desc_blog->breve);?></span></h1>
