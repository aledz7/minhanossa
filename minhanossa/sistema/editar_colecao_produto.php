...
$query_rs_editar_produto = sprintf("SELECT * FROM tbl_colecao WHERE id = %s", GetSQLValueString($colname_rs_editar_produto, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formCatProduto")) {
	$updateSQL = sprintf("UPDATE tbl_colecao SET nome=%s WHERE id=%s",
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="categoria_produto.php">Categoria</a> <span class="separator"></span></li>
        ...
        <div class="maincontent">
            ...
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-th"></span>Editar Coleção</h4>
    ...
    <div class="row">
        <div class="col-md-2">
            ...
            <div class="input-prepend">
                ...
                <input type="text" name="id" class="input-small" placeholder="C�digo" disabled value="<?php echo $row_rs_editar_produto['id'];?>" />
            </div>
        </div>
