...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formCatProduto")) {
  $insertSQL = sprintf("INSERT INTO tbl_categoria (categoria) VALUES (%s)",
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="input-prepend">
                ...
                <input type="text" name="categoria" class="input-xxlarge" placeholder="Escreva o nome da categoria"/>
...
<div class="col-md-11" align="right">
                                ...
                                <a href="categoria_produto.php" class="btn btn-danger btn-mini"> 
