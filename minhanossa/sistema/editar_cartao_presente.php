...
$query_rs_editar_cliente = "SELECT * FROM tbl_cartao_presente WHERE id = '".$_GET['id']."'";
...
if((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formEditCLiente")) {
	...
	$updateSQL = sprintf("UPDATE tbl_cartao_presente SET nome=%s, ativo=%s WHERE id=%s",
	...
	marcaHistoricoAlteracao("Modificou o Cartão Presente {$_POST['nome']}.");
...
<title>Editar Cartão Presente</title>
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="Cartão Presente.php">Cartão Presente</a> <span class="separator"></span></li>
            <li>Atualizar Cartão Presente</li>
        </ul>
        <div class="maincontent">
            <div class="maincontentinner">
            
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-edit"></span>Atualiza Cartão Presente</h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3 container_nome">
                                    Ativo<br>
                                    <div class="input-prepend ">
                                        <input name="ativo" type="checkbox" class="input-xlarge" value="S" <?php if($row_rs_editar_cliente['ativo'] == 'S'){ echo "checked";}?>  />
                                    </div>
                                </div>
