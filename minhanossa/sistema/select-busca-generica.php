		...
		<table width="100%" border="0" cellspacing="3" cellpadding="0">
			<tr>
				<td width="49%">
					...
					<input name="busca" type="search" results='10' autofocus="autofocus" class="txtbox2" id="busca" placeholder="Palavra-Chave" value="<?php echo  ($_POST['busca']); ?>">

				</td>
				<td width="51%"><a href="javascript:;" onclick="document.getElementById('form1Pesquisa').submit()" class="bt71px" style="float:left; margin-left:10px;">Buscar</a><a href="javascript:;" onclick="javascript:parent.window['temp_' + <?php echo  $_GET['janela']; ?>].close();" class="bt63px" style="float:left; margin-left:7px;">Fechar</a>
			...
			<?php if ($totalRows_rs_busca > 0) { ?><tr>
					<td colspan="2">
						<?php do {
						...
						?>
							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:8px; <?php if ($n / 2 == 0) {
								...
								<tr>
									...
									<td width="10%" nowrap="nowrap" class="borda_tabela"><a href="javascript:;" onClick="<?php echo  str_replace('[titulo]', str_replace(array("'", '"'), array("\'", "\'"), $row_rs_busca['titulo']), str_replace('[id]', $row_rs_busca['id'], $_SESSION['javascript_' . $_GET['inputCampo']])); ?>parent.document.getElementById('<?php echo  $_GET['inputCampo']; ?>').value='<?php echo  $row_rs_busca['id']; ?>';parent.document.getElementById('desc_<?php echo  $_GET['inputCampo']; ?>').innerHTML=' - <?php echo str_replace(array("'", '"'), array("\'", "\'"), ($row_rs_busca['nome'].' - '.$row_rs_cores['nome'].' '.$tamanho)); ?>'; parent.window['temp_' + <?php echo  $_GET['janela']; ?>].close();" class="bt86px" style="float:left; margin-left:5px;">Selecionar</a></td>
								</tr>
							</table>
