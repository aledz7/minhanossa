...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formAddCLiente")) {	
	...
	$insertSQL = sprintf("INSERT INTO tbl_cats (categoria) VALUES (%s)",
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            ...
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-edit"></span>Nova Categoria</h4>
                            ...
                            <div class="col-md-12">    
                                ...
                                <div class="col-md-10 container_nome">
                                    ...
                                    <div class="input-prepend ">
                                        <input name="categoria" type="text" class="input-xxlarge" placeholder="Nome da Categoria" />
                                    </div>
                                </div>
							</div>
                        </div>
