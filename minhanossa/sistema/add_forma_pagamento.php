...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formAddCLiente")) {	
	...
	$insertSQL = sprintf("INSERT INTO tbl_forma_pagamento (nome) VALUES (%s)",
		       GetSQLValueString($_POST['nome'], "text"));
	mysql_select_db($database_conexao, $conexao);
	$Result1 = mysql_query($insertSQL, $conexao) or die(mysql_error());
	$idConteudo = mysql_insert_id();

	marcaHistoricoAlteracao("Incluiu a forma de pagamento: {$_POST['nome']}.");
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="forma_pagamento.php">Planos</a> <span class="separator"></span></li>
            <li>Adicionar Forma de Pagamento</li>
        </ul>
        <div class="maincontent">
            <div class="maincontentinner">
            
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-edit"></span>Nova Forma de Pagamento</h4>
