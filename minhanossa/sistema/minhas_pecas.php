...
$currentPage = 'minhas_pecas.php';

mysql_select_db($database_conexao, $conexao);
$query_rs_pecas = "SELECT * FROM tbl_pecas ORDER BY id DESC";
...
<div class="rightpanel">
  ...
  <div class="pageheader">
      ...
      <a href="add_minhas_pecas.php" class="btn btn-primary btn-mini searchbar"> <i class="icon-plus"></i> &nbsp; Novo</a>  
      ...
      <div class="widget">
        ...
        <?php /*?>  <div class="mediamgr_head">
          ...
          <table class="table table-bordered">
            ...
            <?php
			if($totalRows_rs_pecas > 0){
			 do{?>
              <tr>
                <td><?php echo $row_rs_pecas['id'];?></td>
                <td><img src="../img_noticias/<?php echo $row_rs_pecas['foto'];?>" width="70" alt=""></td>
                <td><?php echo $row_rs_pecas['tamanho1'];?></td>
                <td class="centeralign">
                    <a href="editar_minhas_pecas.php?id=<?php echo $row_rs_pecas['id'];?>" class="btn btn-primary btn-mini"> <i class="icon-pencil"></i> &nbsp; Editar
                    </a>
                </td>
                <td>
                	<a href="sql_excluir.php?id=<?php echo $row_rs_pecas['id']; ?>&acao=excluirPecas" class="btn btn-danger btn-mini"> <i class="iconfa-remove"></i> Excluir
                    </a>
								</td>
             </tr>
            <?php }while($row_rs_pecas = mysql_fetch_assoc($rs_pecas));
			}
			?>
