...
$query_rs_categoria = "SELECT * FROM tbl_cores ORDER BY nome ASC";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formCatProduto")) {
  $insertSQL = sprintf("INSERT INTO tbl_cores (nome) VALUES (%s)",
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="input-prepend">
                ...
                <input type="text" name="nome" class="input-xxlarge" placeholder="Escreva o nome da cor"/>
