      ...
      <td width="100%" colspan="4" ><div class="row">
          <div class="col-md-12">
            ...
            <div class="col-md-2"> Valor Unit&aacute;rio<br>
              <div class="input-prepend">
                <input type="text" name="valor_unitario_produto[]" onKeyUp="calcTotalProd(<?php echo $i;?>)" id="valor_unitario_produto<?php echo $i;?>" value="<?php echo $row_rs_editar_item['valor_unitario_produto'];?>" class="input-xxsmall">
                <span class="add-on"><i class="fa fa-usd" aria-hidden="true"></i></span> </div>
            </div>
            <div class="col-md-2"> Desconto<br>
              <div class="input-prepend">
                <input type="text" name="desconto_produto[]" id="desconto_produto<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['desconto_produto'];?>">
              </div>
            </div>
            <div class="col-md-2"> Valor Total<br>
              <div class="input-prepend">
                <input type="text" name="valor_total_produto[]" id="valor_total_produto<?php echo $i;?>" value="<?php echo $row_rs_editar_item['valor_total_produto'];?>" readonly class="input-xxsmall">
                <span class="add-on"><i class="fa fa-usd" aria-hidden="true"></i></span> </div>
            </div>
          </div>
        </div></td>
      ...
      <td><div class="row">
          <div class="col-md-12">
           <?php /*?> <div class="col-md-2"> Data da Prova<br>
              <div class="input-prepend">
                <input type="date" name="data_prova[]" id="data_prova<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['data_prova'];?>" >
                <span class="add-on"><i class="icon-calendar"></i></span> </div>
            </div><?php */?>
            <div class="col-md-2"> Data da Retirada<br>
              <div class="input-prepend">
                <input type="date" name="data_retirada[]" id="data_retirada<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['data_retirada'];?>">
                <span class="add-on"><i class="icon-calendar"></i></span> </div>
            </div>
            <div class="col-md-2"> Data de Devolu&ccedil;&atilde;o<br>
              <div class="input-prepend">
                <input type="date" name="data_devolucao[]" id="data_devolucao<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['data_devolucao'];?>">
                <span class="add-on"><i class="icon-calendar"></i></span> </div>
            </div>
           <?php /*?> <div class="col-md-2"> Retirado em<br>
              <div class="input-prepend">
                <input type="date" name="retirado_em[]" id="retirado_em<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['retirado_em'];?>">
                <span class="add-on"><i class="icon-calendar"></i></span> </div>
            </div>
       ...
       <?php /*?>
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-2"> Busto<br>
              <div class="input-prepend">
                <input type="text" name="busto[]" id="busto<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['busto'];?>" >
                <span class="add-on"><i class="icon-certificate"></i></span> </div>
            </div>
            <div class="col-md-2"> Cintura<br>
              <div class="input-prepend">
                <input type="text" name="cintura[]" id="cintura<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['cintura'];?>">
                <span class="add-on"><i class="icon-certificate"></i></span> </div>
            </div>
            <div class="col-md-2"> Quadril<br>
              <div class="input-prepend">
                <input type="text" name="quadril[]" id="quadril<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['quadril'];?>">
                <span class="add-on"><i class="icon-certificate"></i></span> </div>
            </div>
            <div class="col-md-2"> Corpo<br>
              <div class="input-prepend">
                <input type="text" name="corpo[]" id="corpo<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['corpo'];?>">
                <span class="add-on"><i class="icon-certificate"></i></span> </div>
            </div>
            <div class="col-md-2"> Saia<br>
              <div class="input-prepend">
                <input type="text" name="saia[]" id="saia<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['saia'];?>">
                <span class="add-on"><i class="icon-certificate"></i></span> </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-2"> Paleto<br>
              <div class="input-prepend">
                <input type="text" name="paleto[]" id="paleto<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['paleto'];?>" >
                <span class="add-on"><i class="icon-cog"></i></span> </div>
            </div>
            <div class="col-md-2"> Comprimento<br>
              <div class="input-prepend">
                <input type="text" name="comprimento[]" id="comprimento<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['comprimento'];?>">
                <span class="add-on"><i class="icon-cog"></i></span> </div>
            </div>
            <div class="col-md-2"> Manga<br>
              <div class="input-prepend">
                <input type="text" name="manga[]" id="manga<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['manga'];?>">
                <span class="add-on"><i class="icon-cog"></i></span> </div>
            </div>
            <div class="col-md-2"> Camisa<br>
              <div class="input-prepend">
                <input type="text" name="camisa[]" id="camisa<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['camisa'];?>">
                <span class="add-on"><i class="icon-cog"></i></span> </div>
            </div>
            <div class="col-md-2"> Colete<br>
              <div class="input-prepend">
                <input type="text" name="colete[]" id="colete<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['colete'];?>">
                <span class="add-on"><i class="icon-cog"></i></span> </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-2"> Tamanho<br>
              <div class="input-prepend">
                <input type="text" name="tamanho[]" id="tamanho<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['tamanho'];?>">
                <span class="add-on"><i class="icon-cog"></i></span> </div>
            </div>
            
            <div class="col-md-2"> Colarinho<br>
              <div class="input-prepend">
                <input type="text" name="colarinho[]" id="colarinho<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['colarinho'];?>" >
                <span class="add-on"><i class="icon-asterisk"></i></span> </div>
            </div>
            <div class="col-md-2"> Cal&ccedil;a<br>
              <div class="input-prepend">
                <input type="text" name="calca[]" id="calca<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['calca'];?>">
                <span class="add-on"><i class="icon-asterisk"></i></span> </div>
            </div>
            <div class="col-md-2"> Barra<br>
              <div class="input-prepend">
                <input type="text" name="barra[]" id="barra<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['barra'];?>">
                <span class="add-on"><i class="icon-asterisk"></i></span> </div>
            </div>
            
            <div class="col-md-2"> Cintura<br>
              <div class="input-prepend">
                <input type="text" name="cintura_homem[]" id="cintura_homem<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['cintura_homem'];?>">
                <span class="add-on"><i class="icon-asterisk"></i></span> </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="col-md-2"> Sapato<br>
              <div class="input-prepend">
                <input type="text" name="sapato[]" id="sapato<?php echo $i;?>" class="input-xxsmall" value="<?php echo $row_rs_editar_item['sapato'];?>">
                <span class="add-on"><i class="icon-asterisk"></i></span> </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12"> Coment&aacute;rio<br>
            <div class="input-prepend">
              <textarea name="comentario_item" id="comentario_item<?php echo $i;?>" rows="5" class="span5" placeholder="<?php echo texto('Informações importantes sobre o contrato');?>" style="width:1018px;"><?php echo $row_rs_editar_item['comentario_item'];?>
</textarea>
            </div>
          </div>
        </div>
