...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formAddCLiente")) {	
	...
	$updateSQL = sprintf("UPDATE tbl_lavanderia SET id_cat_produto=%s, id_vendedor=%s, id_loja=%s, id_produto=%s, servico=%s, valor=%s, data_retirada=%s, data_devolucao=%s, data_evento=%s WHERE id=%s",
    ...
    /// HISTORIC PRODUCT
	$updateSQL = sprintf("UPDATE tbl_historico_produto SET id_produto=%s, condicao=%s, data_saida=%s, data_retorno=%s WHERE id_lavanderia=%s",
                       GetSQLValueString($_POST['id_produto'], "text"),
	...
	marcaHistoricoAlteracao("Modificou a lavanderia Código: {$_POST['id']}.");
...
mysql_select_db($database_conexao, $conexao);
$query_rs_ordem_servico = "SELECT tbl_lavanderia.*,  tbl_produto.nome as nomeProduto FROM tbl_lavanderia left join tbl_produto on tbl_lavanderia.id_produto = tbl_produto.id where tbl_lavanderia.id = '{$_GET['id']}'";
...
<title>Lavanderia > Visualizar</title>
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            ...
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-edit"></span>Visualizar Lavanderia</h4>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-prepend">
                                        <select name="id_tipo_lavagem" style="height:32px; width:184px;" >
                       					<?php do{?>
                            				<option value="<?php echo $row_rs_tipo_lavagem['id'];?>" <?php if($row_rs_tipo_lavagem['id'] == $row_rs_ordem_servico['id_tipo_lavagem']) { echo 'selected'; } ?> /><?php echo $row_rs_tipo_lavagem['nome'];?>
