...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="4">Produto: <?=$row_rs_ordem_servico['nomeProduto'];?></td>
  </tr>
  <tr>
    <td colspan="4">Data do Evento: <?=formataData($row_rs_ordem_servico['data_evento']);?></td>
  </tr>
  <tr>
    <td colspan="4">Data da Retirada: <?=formataData($row_rs_ordem_servico['data_retirada']);?></td>
    <td colspan="4">Data da Devolução: <?=formataData($row_rs_ordem_servico['data_devolucao']);?></td>
  </tr>
  <tr>
