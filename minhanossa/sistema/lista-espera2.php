...
<title>Reserva de Pe&ccedil;as</title>
...
<div class="rightpanel">
  <ul class="breadcrumbs">
    ...
    <li><a href="ajustes.php">Reserva de Pe&ccedil;as</a></li>
         ...
         <?php if($totalRows_rs_lista_espera > 0) { ?>
          <table width="100%" class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td width="6%" height="25" style="text-align:center"><strong>Reserva</strong></td>
                <td width="12%" align="center" ><strong>C&oacute;d. do produto</strong></td>
                <td width="14%" ><strong>Produto</strong></td>
                <td width="7%" style="text-align:center" ><strong>Tamanho</strong></td>
                <td width="9%" ><strong>Cor</strong></td>
                <td width="16%"  ><strong>Cliente</strong></td>
                <td width="14%" style="text-align:center" ><strong>Data </strong></td>
                <td width="22%" style="text-align:center"><strong>Op&ccedil;&otilde;es</strong></td>
            ...
            <?php if($totalRows_rs_lista_espera > 0){
              ...
              <tr>
                ...
                <td align="center" ><?php echo utf8_decode($row_rs_lista_espera['codigoProduto']);?></td>
                <td ><?php echo ($row_rs_lista_espera['nomeProduto']);?></td>
                <td style="text-align:center"><?php echo ($row_rs_lista_espera['tamanho']);?></td>
                <td ><?php echo ($row_rs_lista_espera['cor']);?></td>
                <td ><?php echo ($row_rs_lista_espera['nomeCliente']);?></td>
                <td style="text-align:center"><?php echo formataData($row_rs_lista_espera['data']);?></td>
                <td width="22%" style="text-align:center">
					<a href="editar_reserva.php?id=<?php echo $row_rs_lista_espera['id'];?>"class="btn btn-primary btn-mini"> <i class="icon-pencil"></i> &nbsp; Gerenciar
