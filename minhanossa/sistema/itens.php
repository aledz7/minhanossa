...
?>
<input type="hidden" name="pontuacao<?php echo  ($i); ?>" id="pontuacao<?php echo  ($i); ?>">	
<input type="hidden" name="valor_total_produto<?php echo  ($i); ?>" id="valor_total_produto<?php echo  ($i); ?>">	
<table width="100%" border="0" style="margin-bottom:10px;">
		<tbody>
			<tr>
					...
					<td>
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-md-2" style="margin-left: 60px">Pendências<br>
									<div class="input-prepend">
										<select name="pendencias[]" id="pendencias<?php echo  $i; ?>">
											<option value="">Selecione</option>
											<option value="pen" <?php if ($row_rs_editar_item['pendencias'] == 'pen') {
																	echo 'selected';
																} ?>>Nenhuma Pendência</option>
											<option value="loja" <?php if ($row_rs_editar_item['pendencias'] == 'loja') {
																		echo 'selected';
																	} ?>>Conserto - Loja</option>
											<option value="costureira" <?php if ($row_rs_editar_item['pendencias'] == 'costureira') {
																			echo 'selected';
																		} ?>>Conserto - Costureira</option>
											<option value="fornecedo" <?php if ($row_rs_editar_item['pendencias'] == 'fornecedo') {
																			echo 'selected';
																		} ?>>Conserto - Fornecedor</option>
											<option value="mancha" <?php if ($row_rs_editar_item['pendencias'] == 'mancha') {
																		echo 'selected';
																	} ?>>Mancha Lavanderia</option>
											<option value="dano" <?php if ($row_rs_editar_item['pendencias'] == 'dano') {
																		echo 'selected';
																	} ?>>Dano Permanente</option>
