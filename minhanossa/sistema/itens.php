...
?>
<input type="hidden" name="pontuacao<?= ($i); ?>" id="pontuacao<?= ($i); ?>">	
<input type="hidden" name="valor_total_produto<?= ($i); ?>" id="valor_total_produto<?= ($i); ?>">	
<table width="100%" border="0" style="margin-bottom:10px;">
		<tbody>
			<tr>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-md-2" style="margin-left: 60px">Pendências<br>
									<div class="input-prepend">
										<select name="pendencias[]" id="pendencias<?= $i; ?>">
