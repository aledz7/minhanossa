...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formAddCLiente")) {	
	...
	echo "	<script>
			if(confirm('Deseja inserir mais fotos?')){
				window.location='controle-de-fotos-pecas.php?id=$idConteudo&tipo=acervo';	
			}else{
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="nosso_acervo.php">Roupa</a> <span class="separator"></span></li>
