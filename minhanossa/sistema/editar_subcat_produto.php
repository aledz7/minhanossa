...
$query_rs_editar_produto = sprintf("SELECT * FROM tbl_subcategorias WHERE id = %s", GetSQLValueString($colname_rs_editar_produto, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formSubcatProduto")) {
	$updateSQL = sprintf("UPDATE tbl_subcategorias SET nome=%s WHERE id=%s",
...
<title>Editar Subcategoria Produto</title>
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li>Editar Subcategoria</li>
        </ul>
        <div class="maincontent">
            <div class="maincontentinner">
            
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-th"></span>Editar Subcategoria</h4>
...
<input type="hidden" name="MM_update" value="formSubcatProduto">
</p>
