...
if($_GET['acao'] == 'excluir') {
	...
	$deleteSQL = sprintf("DELETE FROM tbl_lavanderia WHERE id=%s",
...
if($_GET['dataInicio'] <> ''){
	$sql .= "and date(tbl_lavanderia.data_retirada) >= '".formataDataSQL($_GET['dataInicio'])."'";
}

if($_GET['dataFim'] <> ''){
	$sql .= " and date(tbl_lavanderia.data_devolucao) <= '".formataDataSQL($_GET['dataFim'])."'";
}

if($_GET['id_produto'] <> ''){
	$sql .= " and tbl_lavanderia.id_produto = '".$_GET['id_produto']."'";
}
...
FROM
	tbl_lavanderia
	left join tbl_produto on tbl_lavanderia.id_produto = tbl_produto.id
where 
	1=1 $sql
ORDER BY 
	tbl_lavanderia.id DESC";
...
<div class="rightpanel">
  <ul class="breadcrumbs">
    ...
    <li><a href="ajustes.php">Lavanderia</a></li>
    
  </ul>
  <div class="pageheader">
  
    	<a href="add-lavanderia.php"class="btn btn-primary btn-mini searchbar"> <i class="icon-plus"></i> &nbsp; Novo</a>
  ...
  <div class="maincontent">
    <div class="maincontentinner">
      <div class="widget">
        <h4 class="widgettitle"><span class="icon-calendar"></span>Lavanderia</h4>
         ...
         <?php if($totalRows_rs_ajustes > 0) { ?>
          <table class="table table-bordered">
            ...
            <?php if($totalRows_rs_ajustes > 0){
			        do{ 
			mysql_select_db($database_conexao, $conexao);
			$query_rs_produto1 = "SELECT * FROM tbl_item WHERE id_lavanderia = '".$row_rs_ajustes['id']."'";
			...
			$totalRows_rs_produto1 = mysql_num_rows($rs_produto1);			
              ...
              <tr>
                ...
                <td width="22%" style="text-align:center">
                	<a href="editar-lavanderia.php?id=<?php echo $row_rs_ajustes['id'];?>"class="btn btn-primary btn-mini"> <i class="icon-pencil"></i> &nbsp; Visualizar  </a>
