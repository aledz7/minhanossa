...
if(basename($_SERVER['SCRIPT_NAME']) == 'editar_contrato.php'){
	...
	$query_rs_editar_item = "SELECT 
	                                tbl_item.*,
	                                tbl_lista_espera.nome as nomeProduto, 
									tbl_lista_espera.pontuacao as Pontuacao, 
									tbl_lista_espera.valor_venda as valorVenda, 
									tbl_lista_espera.numeracao as numeracao,
									tbl_lista_espera.id_cor as id_cor,
									tbl_cores.nome as nomeCor
							   FROM 
							        tbl_item 
							   left join 
							        tbl_lista_espera on tbl_item.nome_produto = tbl_lista_espera.id 
							   left join
							        tbl_cores on tbl_lista_espera.id_cor = tbl_cores.id	
							   where 
