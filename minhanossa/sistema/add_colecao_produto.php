...
$query_rs_categoria = "SELECT * FROM tbl_colecao ORDER BY nome ASC";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formCatProduto")) {
  $insertSQL = sprintf("INSERT INTO tbl_colecao (nome) VALUES (%s)",
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            ...
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-th"></span>Nova Coleção</h4>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="input-prepend">
                ...
                <input type="text" name="nome" class="input-xxlarge" placeholder="Escreva o nome da coleção"/>
...
<div class="col-md-11" align="right">
                                ...
                                <a href="colecao_produto.php" class="btn btn-danger btn-mini"> 
