...
$query_rs_editar_acervo = "SELECT * FROM tbl_acervo WHERE id = '".intval($_GET['id'])."'";
$rs_editar_acervo = mysql_query($query_rs_editar_acervo, $conexao) or die(mysql_error());
$row_rs_editar_acervo = mysql_fetch_assoc($rs_editar_acervo);
$totalRows_rs_editar_acervo = mysql_num_rows($rs_editar_acervo);
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="nosso_acervo.php">Roupas</a> <span class="separator"></span></li>
            <li>Editar Roupa</li>
        </ul>
							...
							<div class="col-md-12">    
									<div class="col-md-10 container_nome">
											...
											<div class="input-prepend">
													<input name="tipo1" type="text" class="input-xxlarge" onchange="checkFilled()" placeholder="Primeira descrição" value="<?php echo $row_rs_editar_acervo['tipo1'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">    
									...
									<div class="col-md-10 container_nome">
											Primeiro Tamanho<br>
											<div class="input-prepend">
													<input name="tamanho1" type="text" class="input-xxlarge" placeholder="Primeiro tamanho" value="<?php echo $row_rs_editar_acervo['tamanho1'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">
									<div class="col-md-10 container_nome">
											Primeiro pontos<br>
											<div class="input-prepend">
													<input name="pontos1" type="text" class="input-xxlarge" placeholder="Primeiro pontos" value="<?php echo $row_rs_editar_acervo['pontos1'];?>" />
											</div>
									</div>
							</div>
					</div>
				  ...
				  <div class="row">
							<div class="col-md-12">    
									...
									<div class="col-md-10 container_nome">
											...
											<div class="input-prepend">
												<input name="valor_loja" type="text" class="input-xxlarge" placeholder="Valor nas outras lojas" value="<?php echo number_format($row_rs_editar_acervo['valor_loja'],2,',','.');?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">    
									<div class="col-md-10 container_nome">
											...
											<div class="input-prepend">
													<input name="tipo2" type="text" class="input-xxlarge" placeholder="Segunda descrição" value="<?php echo $row_rs_editar_acervo['tipo2'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">    
									...
									<div class="col-md-10 container_nome">
											Segundo Tamanho<br>
											<div class="input-prepend">
													<input name="tamanho2" type="text" class="input-xxlarge" placeholder="Segunda tamanho" value="<?php echo $row_rs_editar_acervo['tamanho2'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">
									<div class="col-md-10 container_nome">
											Segundo pontos<br>
											<div class="input-prepend">
													<input name="pontos2" type="text" class="input-xxlarge" placeholder="Segundo pontos" value="<?php echo $row_rs_editar_acervo['pontos2'];?>" />
											</div>
									</div>
							</div>
					</div>
				    ...
				    <div class="row">
							<div class="col-md-12">    
									...
									<div class="col-md-10 container_nome">
											Valor nas outras lojas<br>
											<div class="input-prepend">
												<input name="valor_loja2" type="text" class="input-xxlarge" placeholder="Valor nas outras lojas" value="<?php echo number_format($row_rs_editar_acervo['valor_loja2'],2,',','.');?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">    
									<div class="col-md-10 container_nome">
											...
											<div class="input-prepend">
													<input name="tipo3" type="text" class="input-xxlarge" placeholder="Terceiro descrição" value="<?php echo $row_rs_editar_acervo['tipo3'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">    
									<div class="col-md-10 container_nome">
											Terceiro Tamanho<br>
											<div class="input-prepend">
													<input name="tamanho3" type="text" class="input-xxlarge" placeholder="Terceiro tamanho" value="<?php echo $row_rs_editar_acervo['tamanho3'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">
									<div class="col-md-10 container_nome">
											Terceiro pontos<br>
											<div class="input-prepend">
													<input name="pontos3" type="text" class="input-xxlarge" placeholder="Terceiro pontos" value="<?php echo $row_rs_editar_acervo['pontos3'];?>" />
											</div>
									</div>
							</div>
					</div>
				<div class="row">
							<div class="col-md-12">    
									...
									<div class="col-md-10 container_nome">
											Valor nas outras lojas<br>
											<div class="input-prepend">
												<input name="valor_loja3" type="text" class="input-xxlarge" placeholder="Valor nas outras lojas" value="<?php echo number_format($row_rs_editar_acervo['valor_loja3'],2,',','.');?>" />
											</div>
									</div>
							</div>
					</div>
				...
				<div class="row">
							<div class="col-md-12">    
									<div class="col-md-10 container_nome">
											Quarta Descrição<br>
											<div class="input-prepend">
													<input name="tipo4" type="text" class="input-xxlarge" placeholder="Quarto descrição" value="<?php echo $row_rs_editar_acervo['tipo4'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">    
									...
									<div class="col-md-10 container_nome">
											Quarto Tamanho<br>
											<div class="input-prepend">
													<input name="tamanho4" type="text" class="input-xxlarge" placeholder="Quarto tamanho" value="<?php echo $row_rs_editar_acervo['tamanho4'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">
									<div class="col-md-10 container_nome">
											Quarto pontos<br>
											<div class="input-prepend">
													<input name="pontos4" type="text" class="input-xxlarge" placeholder="Quarto pontos" value="<?php echo $row_rs_editar_acervo['pontos4'];?>" />
											</div>
									</div>
							</div>
					</div>
				    ...
				    <div class="row">
							<div class="col-md-12">    
									...
									<div class="col-md-10 container_nome">
											Valor nas outras lojas<br>
											<div class="input-prepend">
												<input name="valor_loja4" type="text" class="input-xxlarge" placeholder="Valor nas outras lojas" value="<?php echo number_format($row_rs_editar_acervo['valor_loja4'],2,',','.');?>" />
											</div>
									</div>
							</div>
					</div>
				...
				<div class="row">
							<div class="col-md-12">    
									<div class="col-md-10 container_nome">
											Quinta Descrição<br>
											<div class="input-prepend">
													<input name="tipo5" type="text" class="input-xxlarge" placeholder="Quinta descrição" value="<?php echo $row_rs_editar_acervo['tipo5'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">    
									...
									<div class="col-md-10 container_nome">
											Quinto Tamanho<br>
											<div class="input-prepend">
													<input name="tamanho5" type="text" class="input-xxlarge" placeholder="Quinto tamanho" value="<?php echo $row_rs_editar_acervo['tamanho5'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">
									<div class="col-md-10 container_nome">
											Quinto pontos<br>
											<div class="input-prepend">
													<input name="pontos5" type="text" class="input-xxlarge" placeholder="Quinto pontos" value="<?php echo $row_rs_editar_acervo['pontos5'];?>" />
											</div>
									</div>
							</div>
					</div>
				...
				<div class="row">
							<div class="col-md-12">    
									...
									<div class="col-md-10 container_nome">
											Valor nas outras lojas<br>
											<div class="input-prepend">
												<input name="valor_loja5" type="text" class="input-xxlarge" placeholder="Valor nas outras lojas" value="<?php echo number_format($row_rs_editar_acervo['valor_loja5'],2,',','.');?>" />
											</div>
									</div>
							</div>
					</div>
				...
				<div class="row">
							<div class="col-md-12">    
									<div class="col-md-10 container_nome">
											Sexta Descrição<br>
											<div class="input-prepend">
													<input name="tipo6" type="text" class="input-xxlarge" placeholder="Terceiro descrição" value="<?php echo $row_rs_editar_acervo['tipo6'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">    
									...
									<div class="col-md-10 container_nome">
											Sexto Tamanho<br>
											<div class="input-prepend">
													<input name="tamanho6" type="text" class="input-xxlarge" placeholder="Sexto tamanho" value="<?php echo $row_rs_editar_acervo['tamanho6'];?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
							<div class="col-md-12">
									<div class="col-md-10 container_nome">
											Sexto pontos<br>
											<div class="input-prepend">
													<input name="pontos6" type="text" class="input-xxlarge" placeholder="Sexto pontos" value="<?php echo $row_rs_editar_acervo['pontos6'];?>" />
											</div>
									</div>
							</div>
					</div>
				...
				<div class="row">
							<div class="col-md-12">    
									...
									<div class="col-md-10 container_nome">
											Valor nas outras lojas<br>
											<div class="input-prepend">
												<input name="valor_loja6" type="text" class="input-xxlarge" placeholder="Valor nas outras lojas" value="<?php echo number_format($row_rs_editar_acervo['valor_loja6'],2,',','.');?>" />
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12" align="right">
							 ...
							 <a href="controle-de-fotos-pecas.php?id=<?php echo $row_rs_editar_acervo['id'];?>&tipo=Acervo" class="btn btn-mini btn-success"> <i class="iconfa-ok"></i>&nbsp; Mais Fotos</a>
					...
					<input type="hidden" name="id" value="<?php echo $row_rs_editar_acervo['id'];?>">
					<input type="hidden" name="foto_Atual" value="<?php echo $row_rs_editar_acervo['foto'];?>">
		</form>
