...
$query_rs_editar_produto = sprintf("SELECT * FROM tbl_composicoes WHERE id = %s", GetSQLValueString($colname_rs_editar_produto, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formCatProduto")) {
	$updateSQL = sprintf("UPDATE tbl_composicoes SET nome=%s WHERE id=%s",
...
<title>Editar Tipo Lavagem</title>
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="composicoes.php">Tipo Lavagem</a> <span class="separator"></span></li>
            <li>Editar Tipo Lavagem</li>
        </ul>
        <div class="maincontent">
            <div class="maincontentinner">
            
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-th"></span>Editar Tipo Lavagem</h4>
...
<div class="col-md-11" align="right">
    ...
    <a href="composicoes.php" class="btn btn-danger btn-mini"> 
