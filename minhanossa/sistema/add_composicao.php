...
$query_rs_categoria = "SELECT * FROM tbl_composicoes ORDER BY nome ASC";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formCatProduto")) {
  $insertSQL = sprintf("INSERT INTO tbl_composicoes (nome) VALUES (%s)",
...
<title>Cadastro de Tipo de Lavagem</title>
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li>Adicionar Tipo Lavagem</li>
        </ul>
        <div class="maincontent">
            <div class="maincontentinner">
            
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-th"></span>Nova Tipo Lavagem</h4>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="input-prepend">
                ...
                <input type="text" name="nome" class="input-xxlarge" placeholder="Escreva o nome do tipo de lavagem"/>
