...
$query_rs_editar_cliente = "SELECT * FROM tbl_textos WHERE id = '".$_GET['id']."'";
...
if((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formEditCLiente")) {
	...
	$updateSQL = sprintf("UPDATE tbl_textos SET titulo=%s, textos=%s WHERE id=%s",
                       GetSQLValueString($_POST['titulo'], "text"),
                       GetSQLValueString($_POST['textos'], "text"), 
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="planos.php">Textos</a> <span class="separator"></span></li>
            <li>Atualizar Texto</li>
        </ul>
        <div class="maincontent">
            <div class="maincontentinner">
            
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-edit"></span>Atualiza Texto</h4>
           <div class="widgetcontent">
               ...
               <form class="stdform" action="" method="post" name="formEditCLiente" id="formEditCLiente" />
                            ...
                            <div class="col-md-12">   
                                <div class="col-md-12 container_nome">
                                    ...
                                    <div class="input-prepend ">
                                        <input name="titulo" type="text" class="input-xlarge" placeholder="Titulo" value="<?php echo $row_rs_editar_cliente['titulo'];?>" />
                                    </div>
                                </div>
                        ...
                        <div class="row">
                        	<div class="col-md-12">
								Descrição <br>
                        		<textarea name="textos" id="textos" class="ckeditor" style="width: 96%;" rows="5"><?php echo utf8_encode($row_rs_editar_cliente['textos']);?></textarea>
                        	</div>
                        </div>
