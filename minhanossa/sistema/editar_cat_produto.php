...
$query_rs_editar_produto = sprintf("SELECT * FROM tbl_categoria WHERE id = %s", GetSQLValueString($colname_rs_editar_produto, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formCatProduto")) {
	$updateSQL = sprintf("UPDATE tbl_categoria SET categoria=%s WHERE id=%s",
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            ...
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-th"></span>Editar Categoria</h4>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="input-prepend">
                ...
                <input type="text" name="categoria" class="input-xxlarge" value="<?php echo $row_rs_editar_produto['categoria'];?>"/>
            </div>    
        </div>
    </div>
