...
$query_rs_editar_produto = sprintf("SELECT * FROM tbl_cores WHERE id = %s", GetSQLValueString($colname_rs_editar_produto, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formCatProduto")) {
	$updateSQL = sprintf("UPDATE tbl_cores SET nome=%s WHERE id=%s",
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="cores.php">Categoria</a> <span class="separator"></span></li>
            <li>Editar Cores</li>
        </ul>
