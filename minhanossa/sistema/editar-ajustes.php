               ...
               <form class="stdform" action="" method="post" name="formAddCLiente" id="formAddCLiente" />
                      ...
                      <div class="row" style="margin-right:12px;">
                      	<div class="col-md-12" align="right">
                             ...
                             <a href="javascript:;" class="btn btn-primary btn-mini" onClick="MM_openBrWindow('imprimir-ajustes.php?id=<?php echo $row_rs_ordem_servico['id'];?>','imprimirOS','status=yes,width=850,height=450')"> <i class="icon-ok"></i> &nbsp; Imprimir  </a>
