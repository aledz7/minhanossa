...
$query_rs_blog = "SELECT * FROM tbl_blog ORDER BY titulo ASC";
...
<div class="rightpanel">
  ...
  <div class="pageheader">
    	...
    	<a href="add_blog.php"class="btn btn-primary btn-mini searchbar"> <i class="icon-plus"></i> &nbsp; Novo</a>
  ...
  <div class="maincontent">
    <div class="maincontentinner">
      <div class="widget">
        <h4 class="widgettitle"><span class="iconfa-edit"></span>Blog</h4>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td width="747"><strong>Titulo</strong></td>
              	<td width="123">&nbsp;</td>
                <td width="113">&nbsp;</td>
              </tr>
            
            <?php
			if($totalRows_rs_blog > 0){
			 do{?>
              <tr>
                <td><?php echo $row_rs_blog['id'];?></td>
                <td><img src="../../img_noticias/<?php echo $row_rs_blog['foto'];?>" width="70" alt=""></td>
                <td><?php echo utf8_decode($row_rs_blog['titulo']);?></td>
                <td class="centeralign">
                    <a href="editar_blog.php?id=<?php echo $row_rs_blog['id'];?>" class="btn btn-primary btn-mini"> <i class="icon-pencil"></i> &nbsp; Editar
                    
                    </a>
                </td>
                <td>
                	<a href="sql_excluir.php?id=<?php echo $row_rs_blog['id']; ?>&acao=excluirBlog" class="btn btn-danger btn-mini"> <i class="iconfa-remove"></i> Excluir
                    </a>
				</td>
              </tr>
