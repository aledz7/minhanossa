...
<div style="margin-left:3px; margin-right:3px;">
  <table width="100%" border="0">
                <tr>
                  ...
                  <td width="86%">
                  	<a href="javascript:;" onClick="window.location='controle-de-fotos.php?tipo=<?php echo texto($_GET['tipo']);?>&id=<?php echo $_GET['id'];?>&opcoes=' + document.getElementById('opcoes').value" class="btn btn-mini btn-success" style="float:left; margin-left:7px; margin-top: 10px; " >Avan&ccedil;ar</a>
