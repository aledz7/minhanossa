...
$currentPage = 'cats.php';

mysql_select_db($database_conexao, $conexao);
$query_rs_cats = "SELECT * FROM tbl_cats ORDER BY categoria DESC";
...
<div class="rightpanel">
  ...
  <div class="pageheader">
    	...
    	<a href="add_cats.php"class="btn btn-primary btn-mini searchbar"> <i class="icon-plus"></i> &nbsp; Novo</a>
  ...
  <div class="maincontent">
    <div class="maincontentinner">
      <div class="widget">
        <h4 class="widgettitle"><span class="iconfa-edit"></span>Categorias</h4>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td width="650"><strong>Título</strong></td>
              	<td width="80">&nbsp;</td>
                <td width="130">&nbsp;</td>
                <td width="113">&nbsp;</td>
              </tr>
			...
			if($totalRows_rs_cats > 0){
			 do{?>
              <tr>
                <td><?php echo $row_rs_cats['id'];?></td>
                <td><?php echo $row_rs_cats['categoria'];?></td>
                <td class="centeralign">
                    <a href="editar_cats.php?id=<?php echo $row_rs_cats['id'];?>" class="btn btn-primary btn-mini"> <i class="icon-pencil"></i> &nbsp; Editar
                    
                    </a>
                </td>
                <td>
                  <a href="sub_cat_produto.php?id_categoria=<?php echo $row_rs_cats['id'];?>"class="btn btn-primary btn-mini"> 
                    <i class="icon-pencil"></i> &nbsp; Subcategoria
                  </a> 
                </td>
                <td>
                	<a href="sql_excluir.php?id=<?php echo $row_rs_cats['id']; ?>&acao=excluirCats" class="btn btn-danger btn-mini"> <i class="iconfa-remove"></i> Excluir
                    </a>
				</td>
              </tr>
