...
if($_GET['acao'] == 'excluir') {
	...
	$deleteSQL = sprintf("DELETE FROM tbl_ajustes WHERE id=%s",
...
if($_GET['dataInicio'] <> ''){
	$sql .= "and date(tbl_ajustes.data_entrada) >= '".formataDataSQL($_GET['dataInicio'])."'";
}

if($_GET['dataFim'] <> ''){
	$sql .= " and date(tbl_ajustes.data_entrada) <= '".formataDataSQL($_GET['dataFim'])."'";
}

if($_GET['id_produto'] <> ''){
	$sql .= " and tbl_ajustes.id_produto = '".$_GET['id_produto']."'";
}
...
FROM
	tbl_ajustes
	left join tbl_produto on tbl_ajustes.id_produto = tbl_produto.id
where 
	1=1 $sql
ORDER BY 
	tbl_ajustes.id DESC";
...
<div class="rightpanel">
  <ul class="breadcrumbs">
    ...
    <li><a href="ajustes.php">Consertos</a></li>
    
  </ul>
  <div class="pageheader">
  
    	<a href="add-ajustes.php"class="btn btn-primary btn-mini searchbar"> <i class="icon-plus"></i> &nbsp; Novo</a>
  ...
  <div class="maincontent">
    <div class="maincontentinner">
      <div class="widget">
        <h4 class="widgettitle"><span class="icon-calendar"></span>Consertos</h4>
                    	...
                    	<ul class="mediamgr_menu">
                            <li class="filesearch">
                                   ...
                                   <div class="input-prepend">
                                      ...
                                      <input id="dataFim" value="<?php echo $_GET['dataFim'];?>" style="padding:5px;" type="text" name="dataFim" class="input-small datepicker" />                                   
								</div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td width="10%" style="text-align:center" ><strong>Data da Retirada</strong></td>
                <td width="10%" style="text-align:center"><strong>Data da Devolu&ccedil;&atilde;o</strong></td>
            ...
            <?php if($totalRows_rs_ajustes > 0){
              ...
              <tr>
                ...
                <td ><?php echo $row_rs_ajustes['nomeProduto'];?></td>
                <td style="text-align:center"><?php echo formataData($row_rs_ajustes['data_evento']);?></td>
                <td style="text-align:center"><?php echo formataData($row_rs_ajustes['data_retirada']);?></td>
                <td style="text-align:center"><?php echo formataData($row_rs_ajustes['data_devolucao']);?></td>
                <td width="22%" style="text-align:center">
                	<a href="editar-ajustes.php?id=<?php echo $row_rs_ajustes['id'];?>"class="btn btn-primary btn-mini"> <i class="icon-pencil"></i> &nbsp; Visualizar  </a>
