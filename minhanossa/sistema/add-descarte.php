...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formAddCLiente")) {	
	  $insertSQL = sprintf("INSERT INTO tbl_descarte (id_produto, id_vendedor, data_descarte, forma_descarte) VALUES (%s, %s, %s, %s)",
            ...
            GetSQLValueString($_POST['data_descarte'], "text"),
            GetSQLValueString($_POST['forma_descarte'], "text"));
  	mysql_select_db($database_conexao, $conexao);
  	$Result1 = mysql_query($insertSQL, $conexao) or die(mysql_error());
  	$idConteudo = mysql_insert_id();
	

    //SELECIONA O PRODUTO A SER DESCARTADO
mysql_select_db($database_conexao, $conexao);
$query_rs_pega_produto = "SELECT * FROM tbl_produto WHERE id = '".$_POST['id_produto']."'";
$rs_pega_produto = mysql_query($query_rs_pega_produto, $conexao) or die(mysql_error());
$row_rs_pega_produto = mysql_fetch_assoc($rs_pega_produto);
$totalRows_rs_pega_produto = mysql_num_rows($rs_pega_produto);

$descarte = $row_rs_pega_produto['qnt_estoque'] - 1;


///ATUALIZA O ESTOQUE DO PRODUTO
$updateSQL = sprintf("UPDATE tbl_produto SET qnt_estoque=%s WHERE id=%s",
                       GetSQLValueString($descarte, "text"),
                       GetSQLValueString($_POST['id_produto'], "int")); 
	mysql_select_db($database_conexao, $conexao);
	$Result1 = mysql_query($updateSQL, $conexao) or die(mysql_error());

  marcaHistoricoAlteracao("Descartou o produto : {$idConteudo}.");
...
<?php include_once('inc_coluna.php');?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="">Descarte</a> <span class="separator"></span></li>
            <li>Novo</li>
        </ul>
        <div class="maincontent">
            ...
            <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-edit"></span>Novo Descarte</h4>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="input-prepend">
                                      <input type="date" name="data_descarte" style="width:130px;" class="input-xlarge" />
                                    <span class="add-on"><i class="icon-edit"></i></span>
                                    </div>
                                </div>
                                
                              <div class="col-md-2">
                                    Forma de Descarte<br>
                                    <div class="input-prepend">
                                        <select name="forma_descarte" style="height:32px; width:100px;">
                       					    <option value="D"/>Doação
                                            <option value="U"/>Upcyling
                                            <option value="R"/>Reciclagem
                       					</select>
                                		<span class="add-on"><i class="icon-edit"></i></span>
                                    </div>
                                </div>
