...
$query_rs_produto = "SELECT * FROM tbl_categoria WHERE id is not null $sql ORDER BY categoria ASC";
...
<div class="rightpanel">
  <ul class="breadcrumbs">
    ...
    <li><a href="categoria_produto.php">Produto</a></li>
    
  </ul>
  <div class="pageheader">
  
    	<a href="add_cat_produto.php"class="btn btn-primary btn-mini searchbar"> <i class="icon-plus"></i> &nbsp; Novo</a>
  ...
  <div class="maincontent">
    <div class="maincontentinner">
      <div class="widget">
        <h4 class="widgettitle"><span class="iconfa-edit"></span>Categoria de Produtos</h4>
			 ...
			 do{?>
              <tr>
                ...
                <td class="centeralign">
                  <a href="editar_cat_produto.php?id=<?php echo $row_rs_produto['id'];?>"class="btn btn-primary btn-mini" style="font-size:9px;"> 
                    <i class="icon-pencil"></i> &nbsp; Editar
                  </a>
                  <a href="sql_excluir.php?id=<?php echo $row_rs_produto['id']; ?>&acao=excluirCatProduto" class="btn btn-danger btn-mini" style="font-size:10px; margin-left:7px;"> 
