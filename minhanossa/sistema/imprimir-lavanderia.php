...
<table width="100%" style="border:solid 1px #CCCCCC" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="50" style="padding-left:8px;" ><strong><?php echo $row_rs_config['nome'];?></strong></td>
    <td width="50%" align="right" valign="top"  style="padding-top:5px; padding-bottom:5px; padding-right:5px;"><?php echo $row_rs_config['logradouro'];?> <br />
     <?php echo $row_rs_config['cidadeLoja'];?> / <?php echo $row_rs_config['estadoLoja'];?> - Fone: <?php echo $row_rs_config['telefone'];?><br />
      <?php echo $row_rs_config['cnpj'];?></td>
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="4">Id Produto: <?php echo $row_rs_itens_produtos['id'];?></td>
  </tr>
   <tr>
    <td colspan="4">Produto: <?php echo $row_rs_itens_produtos['nome'];?></td>
  </tr>
 <?php /*?> <tr>
    <td colspan="4">Data do Evento: <?php echo formataData($row_rs_ordem_servico['data_evento']);?></td>
  </tr><?php */?>
  <tr>
    <td colspan="4">Data da Retirada: <?php echo formataData($row_rs_editar_item['data_retirada']);?></td>
    <td colspan="4">Data da Devolução: <?php echo formataData($row_rs_editar_item['data_devolucao']);?></td>
  </tr>
  <tr>
