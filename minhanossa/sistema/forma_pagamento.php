...
$query_rs_forma_pagamento = "SELECT * FROM tbl_forma_pagamento WHERE id is not null $sql ORDER BY nome ASC";
...
<div class="rightpanel">
  <ul class="breadcrumbs">
    ...
    <li><a href="forma_pagamento.php">Cadastro</a></li>
   
  </ul>
  <div class="pageheader">
  
    	<a href="add_forma_pagamento.php"class="btn btn-primary btn-mini searchbar"> <i class="icon-plus"></i> &nbsp; Nova</a>
  ...
  <div class="maincontent">
    <div class="maincontentinner">
      <div class="widget">
        <h4 class="widgettitle"><span class="iconfa-edit"></span>Forma de Pagamento</h4>
			 ...
			 do{?>
              <tr>
                ...
                <td class="centeralign">
                    <a href="editar_forma_pagamento.php?id=<?php echo $row_rs_forma_pagamento['id'];?>" class="btn btn-primary btn-mini"> <i class="icon-pencil"></i> &nbsp; Editar
                    
                    </a>
                </td>
                <td>
                	<a href="sql_excluir.php?id=<?php echo $row_rs_forma_pagamento['id']; ?>&acao=excluirFormaPagamento" class="btn btn-danger btn-mini"> <i class="iconfa-remove"></i> Excluir
                    </a>
				</td>
              </tr>
