    ...
    $.fn.bcalendar = function(option) {
        ...
        function BuildWT(ht, dayarrs, events, dMax) {
            ...
            for (var i = 0; i < dayarrs.length; i++) {
				...
				var dia = dayarrs[i].display;
				if(dia.substr(6,1) == '/') {
					dia = dia.substr(7,2) + '/' + dia.substr(4,2) + ' - ' + dia.substr(0,3);
				} else {
					dia = dia.substr(6,2) + '/' + dia.substr(4,1) + ' - ' + dia.substr(0,3);
				}
                ht.push("<th abbr='", dateFormat.call(dayarrs[i].date, i18n.xgcalendar.dateformat.fulldayvalue), "' class='gcweekname' scope=\"col\"><div title='", title, "' ", ev, " class='wk-dayname'><span class='", cl, "'>", dia, "</span></div></th>");
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" style="color:#000; text-decoration:none; font-weight:bold" title="'
					...
					var dataCorreta = ss.join("");
					dataCorreta = dataCorreta.substr(4,2) + '/' + dataCorreta.substr(0,3) + ' - ' + dataCorreta.substr(6,6) + dataCorreta.substr(12,6);
					
                    var ts = $("#bbit-cs-buddle-timeshow").html(dataCorreta);
