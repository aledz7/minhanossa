...
mysql_select_db($database_conexao, $conexao);
$query_rs_editar_produto = sprintf("SELECT * FROM tbl_produto WHERE id = %s", GetSQLValueString($colname_rs_editar_produto, "int"));
...
mysql_select_db($database_conexao, $conexao);
$query_rs_subcategoria = sprintf("SELECT * FROM tbl_subcategorias WHERE id_categoria = %s", GetSQLValueString($row_rs_editar_produto['categoria'], "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formProduto")) {
    $updateSQL = sprintf(
        "UPDATE tbl_produto SET categoria=%s, qnt_estoque=%s, nome=%s, preco_custo=%s, valor_aluguel=%s, valor_venda=%s, foto=%s, tipo=%s, id_fornecedor=%s, id_colecao=%s, id_composicao=%s, descricao=%s, id_cor=%s, numeracao=%s, pontuacao=%s, modo_lavagem=%s, origem=%s, codigoBarra=%s, status=%s WHERE id=%s",
        GetSQLValueString($_POST['categoria'], "int"),
        GetSQLValueString($_POST['qnt_estoque'], "int"),
        GetSQLValueString($_POST['nome'], "text"),
        GetSQLValueString(valorCalculavel($_POST['preco_custo']), "text"),
        GetSQLValueString(valorCalculavel($_POST['valor_aluguel']), "text"),
        GetSQLValueString(valorCalculavel($_POST['valor_venda']), "text"),
        GetSQLValueString(upload("foto", "imgs-sis", "N"), "text"),
        GetSQLValueString($_POST['tipo'], "int"),
        GetSQLValueString($_POST['id_fornecedor'], "int"),
        GetSQLValueString($_POST['id_colecao'], "int"),
        GetSQLValueString($_POST['id_composicao'], "int"),
        GetSQLValueString($_POST['descricao'], "text"),
        GetSQLValueString($_POST['id_cor'], "int"),
        ...
        GetSQLValueString(str_pad($_POST['codigoBarra'], 12, "0", STR_PAD_LEFT), "text"),
    ...
    <div class="mainwrapper">
        ...
        <div class="rightpanel">
            ...
            <div class="maincontent">
                <div class="maincontentinner">
                    ...
                    <div class="widget">
                        <h4 class="widgettitle"><span class="iconfa-th"></span>Editar Produto</h4>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-prepend">
                                            <select name="origem" class="uniformselect">
                                                <option value="L" <?php if ($row_rs_editar_produto['origem'] == 'L') {
                                                                        echo "selected";
                                                                    } ?>>Loja</option>
                                                <option value="E" <?php if ($row_rs_editar_produto['origem'] == 'E') {
                                                                        echo "selected";
                                                                    } ?>>E-commerce</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-prepend">
                                            <select name="status" class="uniformselect">
                                                <option value=""></option>
                                                <option value="A" <?php if ($row_rs_editar_produto['status'] == 'A') {
                                                                        echo "selected";
                                                                    } ?>>Ativo</option>
                                                <option value="I" <?php if ($row_rs_editar_produto['status'] == 'I') {
                                                                        echo "selected";
                                                                    } ?>>Inativo</option>
                                            </select>
                                        </div>
            ...
            <div class="input-prepend">
                ...
                <input type="text" name="codigoBarra" class="input-xlarge" placeholder="Código de Barra" value="<?php echo $row_rs_editar_produto['codigoBarra']; ?>"/>
                
            </div>
        </div> -->

                                    <?php /*?>  <div class="col-sm-4">
                   <iframe src="barras.php?codigoBarra=<?php echo $row_rs_editar_produto['codigoBarra'];?>&nomeGif=<?php echo $row_rs_editar_produto['id'];?>produto.gif" frameborder="0"></iframe>
        </div><?php */ ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-prepend">
                                            <select name="categoria" id="categoria" class="uniformselect">
                                                <?php do { ?>
                                                    <option value="<?php echo $row_rs_categoria['id']; ?>" <?php if ($row_rs_editar_produto['categoria'] == $row_rs_categoria['id']) {
                                                                                                                echo "selected";
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-prepend">
                                            <select name="id_fornecedor" class="uniformselect">
                                                <?php do { ?>
                                                    <option value="<?php echo $row_rs_fornecedor['id']; ?>" <?php if ($row_rs_editar_produto['id_fornecedor'] == $row_rs_fornecedor['id']) {
                                                                                                                echo "selected";
                                                                                                            } ?>><?php echo $row_rs_fornecedor['nome']; ?></option>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        Nome<br>
                                        <div class="input-prepend">
                                            <input type="text" name="nome" class="input-xlarge" placeholder="Nome" value="<?php echo $row_rs_editar_produto['nome']; ?>" />
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-prepend">
                                            ...
                                            <input type="number" name="qnt_estoque" class="input-small" value="<?php echo $row_rs_editar_produto['qnt_estoque']; ?>" />
                                            <span class="add-on"><i class="iconfa-shopping-cart"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        Numera&ccedil;&atilde;o<br>
                                        <div class="input-prepend">

                                            <input type="text" name="numeracao" class="input-small" value="<?php echo $row_rs_editar_produto['numeracao']; ?>" />
                                            <span class="add-on"><i class="iconfa-shopping-cart"></i></span>
                                        </div>
                                    </div>                                    
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        Cole&ccedil;&atilde;o<br>
                                        <div class="input-prepend">
                                            <select name="id_colecao" class="uniformselect">
                                                <?php do { ?>
                                                    <option value="<?php echo $row_rs_colecao['id']; ?>" <?php if ($row_rs_editar_produto['id_colecao'] == $row_rs_colecao['id']) {
                                                                                                            echo "selected";
                                                                                                        } ?>><?php echo $row_rs_colecao['nome']; ?></option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-prepend">
                                            <select name="id_cor" class="uniformselect">
                                                <?php do { ?>
                                                    <option value="<?php echo $row_rs_cores['id']; ?>" <?php if ($row_rs_editar_produto['id_cor'] == $row_rs_cores['id']) {
                                                                                                            echo "selected";
                                                                                                        } ?>><?php echo $row_rs_cores['nome']; ?></option>
            ...
            <div class="input-prepend">
                <select name="id_composicao" class="uniformselect">
					<?php do { ?>
                    	<option value="<?php echo $row_rs_composicao['id']; ?>" <?php if ($row_rs_editar_produto['id_composicao'] == $row_rs_composicao['id']) {
                                                                                    echo "selected";
                                                                                } ?> ><?php echo $row_rs_composicao['nome']; ?></option>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-prepend">
                                            ...
                                            <input type="text" name="preco_custo" class="input-medium" value="<?php echo number_format($row_rs_editar_produto['preco_custo'], 2, ',', '.'); ?>" />
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-prepend">
                                            ...
                                            <input type="text" name="valor_aluguel" class="input-medium" value="<?php echo number_format($row_rs_editar_produto['valor_aluguel'], 2, ',', '.'); ?>" />
                                            <span class="add-on"><i class="fa fa-usd"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-prepend">
                                            ...
                                            <input type="text" name="valor_venda" class="input-medium" value="<?php echo number_format($row_rs_editar_produto['valor_venda'], 2, ',', '.'); ?>" />
                                            <span class="add-on"><i class="fa fa-usd"></i></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-prepend">
                                            <select name="tipo" class="uniformselect">
                                                ...
                                                <option value="1" <?php if ($row_rs_editar_produto['id_composicao'] == '1') {
                                                                        echo "selected";
                                                                    } ?>>MASCULINO</option>
                                                <option value="2" <?php if ($row_rs_editar_produto['id_composicao'] == '2') {
                                                                        echo "selected";
                                                                    } ?>>FEMININO</option>
       ...
       <div class="col-md-3">
            ...
            <div class="input-prepend">
                ...
                <input type="text" name="pontuacao" class="input-medium" value="<?php echo $row_rs_editar_produto['pontuacao']; ?>"/>
                <span class="add-on"><i class="fa fa-pencil"></i></span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            Descrição<br>
                                            <div class="input-prepend">
                                                <textarea name="descricao" id="descricao" rows="5" class="span5" style="width:1000px;"><?php echo $row_rs_editar_produto['descricao']; ?></textarea>
                            	...
                            	<div class="col-md-12">
                                    Modo de Lavagem<br>
                                    <div class="input-prepend">
                                        <textarea name="modo_lavagem" id="modo_lavagem" rows="5" class="span5" style="width:1000px;"><?php echo $row_rs_editar_produto['modo_lavagem']; ?></textarea>
