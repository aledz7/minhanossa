...
if ($_GET['status'] <> '') {
  $sql_status .= " and tbl_cores.status = '" . $_GET['status'] . "'";
} else {
  $sql_status .= "and (tbl_cores.status = 'A' OR tbl_cores.status = 'I') ";
}

mysql_select_db($database_conexao, $conexao);
$query_rs_produto = "SELECT * FROM tbl_cores WHERE id IS NOT NULL $sql $sql_status ORDER BY nome ASC";
  ...
  <div class="mainwrapper">
    ...
    <div class="rightpanel">
      ...
      <div class="pageheader">
        ...
        <a href="add_cores.php" class="btn btn-primary btn-mini searchbar"> <i class="icon-plus"></i> &nbsp; Novo</a>
      ...
      <div class="maincontent">
        <div class="maincontentinner">
          <div class="widget">
            <h4 class="widgettitle"><span class="iconfa-edit"></span>Cores</h4>
                    ...
                    do { ?>
                      <tr>
                        ...
                        <td class="centeralign">
                          ...
                          <a href="sql_excluir.php?id=<?php echo $row_rs_produto['id']; ?>&acao=excluirCores" class="btn btn-danger btn-mini" style="font-size:10px; margin-left:7px;"> <i class="iconfa-remove"></i> Excluir
                          </a>
                        </td>
                        <td></td>
                      </tr>
