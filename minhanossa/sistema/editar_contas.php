...
if((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formEditContrato")) {
	$updateSQL = sprintf("UPDATE tbl_contas SET pago=%s, valor_total=%s, data_emissao=%s, data_vencimento=%s, descricao=%s WHERE id=%s",
...
mysql_select_db($database_conexao, $conexao);
$query_rs_editar_contas_receber = sprintf("SELECT * FROM tbl_contas WHERE id = %s", GetSQLValueString($colname_rs_editar_contas_receber, "int"));
            ...
            <div class="widgetcontent">
               ...
               <form class="stdform" action="" method="post" name="formEditContrato" id="formEditContrato" />
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-prepend">
                                        <select name="pago" id="pago" style="height:32px;">
                                            <option value="S" <?php if($row_rs_editar_contas_receber['pago'] == 'S') { echo 'selected'; } ?>>Sim</option>
                                            <option value="N" <?php if($row_rs_editar_contas_receber['pago'] == 'N') { echo 'selected'; } ?>>Não</option>
                                        </select>
                       ...
                       <div class="row">
                        ...
                        <input type="hidden" name="tipo" value="<?php echo $row_rs_editar_contas_receber['tipo'];?>">
