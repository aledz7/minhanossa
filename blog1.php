                ...
                <div class="lib-panel" >
                    <div class="row box-shadow">
						...
						<div class="row">
							...
							<div class="parapending col-xs-12 col-sm-8 col-md-8 col-lg-8" style="border: solid 2px; border-radius: 7%; margin-bottom: 20px;">
								<div>
									<a href="desc-blog.php?id=<?php echo $i_blog->id;?>">
									<h1 class="text-left txtcenter" style="font-size: 18px;"><span style="color: #f1c93b; text-shadow: #000 -0px 1px 4px;"><?php echo utf8_decode($i_blog->titulo);?></span><span style="color: #c25868;"><?php echo utf8_decode($i_blog->breve);?></span></h1>
									<div class="lib-header-seperator"></div>
									</a>
								</div>
								<div class="paraimg col-xs-12 col-sm-4 col-md-4 col-lg-4">
