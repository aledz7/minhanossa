                ...
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                  <div role="tabpanel">
                        ...
                        <div class="tab-content">
                          <?php /*?>  <div role="tabpanel" class="tab-pane " id="minha-whishlist">
                                 <div class="clearfix">&nbsp;</div>
                                 <div class="clearfix">&nbsp;</div>
                                   <?php $preferidos = $produtos->rsDados();
								foreach($preferidos as $itemPreferidos) { 
								//$categoria = $conteudos->rsDados('', $novidade->id_categoria);
								?>
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                        <div class="thumbnail">
                                            <img src="img_noticias/<?php echo $itemPreferidos->foto;?>" alt="">
                                            <div class="caption deg-produto-rosa text-left caption-color" style="padding: 53px 10px 0px;">
                                                ...
                                                <h4><?php echo $itemPreferidos->nome;?></h4>
                                                <div class="clearfix">&nbsp;</div>
                                                <div class="estrela">
                           ...
                           <?php /*?> <div role="tabpanel" class="tab-pane" id="reservadas">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="ja-usei">
                                <div class="clearfix">&nbsp;</div>
                                 <div class="clearfix">&nbsp;</div>
								...
								?>
                                        ...
                                        <div class="thumbnail">
                                           ...
                                           <?php }?>
                                            <div class="caption deg-produto-azul text-left caption-color" style="padding: 53px 10px 0px; height: 112px;">
                                                <?php /*?><small><?php echo utf8_decode($nomeProduto->nomeCategoria);?></small><?php */?>
                                    ...
                                    <?php }else{?>
                                    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    		<p><strong>Nenhum produto usado ainda :(</strong></p>
                                    	</div>
                                    <?php }?>
                            </div>
