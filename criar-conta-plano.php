...
<!--
                                   <p style="text-align: justify">
									   Eba! Esse presente vai ser um sucesso. Vamos mandar um e-mail pra moça de sorte explicando tudinho sobre o nosso funcionamento. E psiu, ajuda a lembrá-la que ela tem até 15 dia para confirmar o cadastro na loja física com a gente.
								   </p>
-->
                               </div>
                                       ...
                                       <span class="numeral" style="<?php echo $numero;?>">
                                        ...
                                        <div class="caption" style="<?php echo $descricao;?>">
                                            ...
                                            <p>
                                                ...
                                                <button type="submit" class="btn btn-primary" style="<?php echo $botao;?>">Assinar!</button>
